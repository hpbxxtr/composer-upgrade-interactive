...
[![Documentation][docs-shield-url]][docs-url]
...
<p align="center">
  📖 <a href="https://hpbxxtr.github.io/composer-upgrade-interactive/"><strong>Read the documentation</strong></a>
</p>
...
- **Minimum release age** — gate out releases published minutes ago, project-wide or per run
...
Full docs live at **[hpbxxtr.github.io/composer-upgrade-interactive][docs-url]**:

- [Installation][docs-installation-url] · [Usage][docs-usage-url]
- [Minimum release age][docs-min-age-url] — cooldown before a fresh release may be selected
- [Key bindings][docs-key-bindings-url] — normal mode, version picker, age input
- [How it works][docs-how-it-works-url] — resolution, conflict detection, apply
- [CLI reference][docs-cli-url] · [Configuration reference][docs-configuration-url]

The site is built with [VitePress](https://vitepress.dev) from [`docs/`](docs) and deployed to GitHub Pages on release. To preview it locally:
...
[hero-img]: ./docs/public/composer_hui.png
[demo-img]: ./docs/public/demo.gif

[docs-url]: https://hpbxxtr.github.io/composer-upgrade-interactive/
[docs-shield-url]: https://img.shields.io/badge/docs-online-40e5ff?style=flat-square&logo=vite&logoColor=40e5ff&labelColor=0d0d1a
[docs-installation-url]: https://hpbxxtr.github.io/composer-upgrade-interactive/guide/installation
[docs-usage-url]: https://hpbxxtr.github.io/composer-upgrade-interactive/guide/usage
[docs-min-age-url]: https://hpbxxtr.github.io/composer-upgrade-interactive/guide/minimum-release-age
[docs-key-bindings-url]: https://hpbxxtr.github.io/composer-upgrade-interactive/guide/key-bindings
[docs-how-it-works-url]: https://hpbxxtr.github.io/composer-upgrade-interactive/guide/how-it-works
[docs-cli-url]: https://hpbxxtr.github.io/composer-upgrade-interactive/reference/cli
[docs-configuration-url]: https://hpbxxtr.github.io/composer-upgrade-interactive/reference/configuration
